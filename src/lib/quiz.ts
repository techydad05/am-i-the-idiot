...
export const civicsQuiz: Question[] = [
  ...
  { id: 20, text: "Which amendment abolished slavery in the United States?", options: ["12th", "13th", "14th", "15th"], correctAnswer: 1, fact: "The 13th Amendment ended slavery, though the struggle for true equality continued.", difficulty: 'medium', category: 'constitution' },
  ...
  { id: 25, text: "What is the 'Cabinet' in the executive branch?", options: ["The room where the President sleeps", "A group of advisors who lead the major executive departments", "The secret service", "The joint chiefs of staff"], correctAnswer: 1, fact: "The Cabinet provides specialized expertise to the President.", difficulty: 'medium', category: 'branches' },
  { id: 26, text: "Which amendment protects against 'unreasonable searches and seizures'?", options: ["1st", "2nd", "4th", "5th"], correctAnswer: 2, fact: "The 4th Amendment requires warrants based on probable cause.", difficulty: 'medium', category: 'rights' },
  ...
  { id: 34, text: "The Constitution was signed in what year?", options: ["1776", "1787", "1791", "1800"], correctAnswer: 1, fact: "The Constitution was signed on September 17, 1787, by 39 delegates at the Constitutional Convention.", difficulty: 'easy', category: 'constitution' },
  ...
  { id: 49, text: "In which year was the first presidential election?", options: ["1776", "1788", "1792", "1800"], correctAnswer: 1, fact: "George Washington was elected President in 1788, the first presidential election.", difficulty: 'easy', category: 'elections' },
  ...
  { id: 61, text: "What is the term length for a US Senator?", options: ["2 years", "4 years", "6 years", "8 years"], correctAnswer: 2, fact: "Senators serve 6-year terms, with elections staggered so roughly one-third are elected every 2 years.", difficulty: 'medium', category: 'branches' },
