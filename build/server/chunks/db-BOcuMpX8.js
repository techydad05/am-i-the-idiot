...
var schema_exports = /* @__PURE__ */ __exportAll({ leaderboard: () => leaderboard });
var leaderboard = sqliteTable("leaderboard", {
	id: integer("id").primaryKey({ autoIncrement: true }),
	name: text("name").notNull(),
	score: integer("score").notNull(),
	timestamp: integer("timestamp", { mode: "timestamp" }).$defaultFn(() => /* @__PURE__ */ new Date())
});
var db = drizzle(new Client("sqlite.db"), { schema: schema_exports });

export { db as d, leaderboard as l };
//# sourceMappingURL=db-BOcuMpX8.js.map
